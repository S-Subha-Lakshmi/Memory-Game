...
function startGame() {
    ...
    document.getElementById('stop-btn').style.display = 'block'; // Show Stop button when game starts
}
...
function stopGame() {
    ...
    document.getElementById('timer').style.display = 'none'; // Hide the timer when game stops
    clearInterval(timerInterval); // Stop the timer
    alert('Game Over!');
